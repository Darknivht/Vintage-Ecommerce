...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'userauths.context_processors.user_role_context',
...
FLUTTERWAVE_PLATFORM_SUBACCOUNT_ID = "RS_7192AD7B2915722E9B9FD1DC845C1BF0"  # Your platform's Flutterwave subaccount ID
